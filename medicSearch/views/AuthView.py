...
def register_view(request):
    ...
    if request.method == 'POST':
        ...
        if registerForm.is_valid():
            # Aqui verificamos se existe usuário ou e-mail com esse cadastro, para só então fazer o cadastro
    ...
    context = {
        'form': registerForm,
        'message': message,
        'title': 'Registrar','button_text': 'Registrar',
        'link_text': 'Login',
        'link_href': '/login'
    }
...
def change_password(request, token):
    ...
    context = {
        ...
        'message': message,'title': 'Alterar senha',
        'button_text': 'Alterar',
        'link_text': link_text,
        'link_href': link_href
    }
